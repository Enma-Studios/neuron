...
NEURON_DGRAPH_TRANSPORT=grpc \
  mix test --include integration test/neuron_dgraph_integration_test.exs test/neuron_campaign_pipeline_integration_test.exs test/neuron_intake_excerpt_test.exs test/neuron_intake_answers_test.exs test/neuron_leadership_people_test.exs test/neuron_people_pages_test.exs test/neuron_company_list_test.exs
